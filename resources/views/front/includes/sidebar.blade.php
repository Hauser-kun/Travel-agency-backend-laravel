        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                <li class="nav-item">
                    ...
                    <a class="nav-link active" href="{{ route('account.users') }}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active" href="{{ route('account.blogs') }}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('account.news') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">News and Articles</span>
                    </a>
                </li>
                {{-- <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="notifications.php">Notifications</a>
                            </li>
                ...
                {{-- <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link" href="reset-password.php">Reset
                                    password</a></li>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('account.packages') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Tour Package</span>
                    </a>
                </li>

                <li class="nav-item">

                    <a class="nav-link" href="{{ route('account.places') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-columns-gap"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <span class="nav-link-text">Tour Places</span>
                    </a>
                </li>
