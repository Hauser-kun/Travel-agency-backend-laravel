    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <h1 style="text-transform:uppercase" class="app-page-title">{{ Auth::user()->name }}</h1>

                {{-- <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                    <div class="inner">
                        <div class="app-card-body p-3 p-lg-4">
                            <h3 class="mb-3">Welcome, Athiti Travels!</h3>
                            <div class="row gx-5 gy-3">
                                <div class="col-12 col-lg-9">

                                    <div style="text-transform: uppercase">Welcome To admin Dashboard {{ Auth::user()->name }} </div>
                                </div>
                ...
                {{-- <div class="row g-4 mb-4">
                    <div class="col-6 col-lg-3">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                <h4 class="stats-type mb-1">New Student Admissions</h4>
                                <div class="stats-figure">NA</div>
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                <h4 class="stats-type mb-1">Collected Fees</h4>
                                <div class="stats-figure">Rs 0.00</div>
                                <div class="stats-meta text-success">
